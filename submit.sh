...
submit_job experiment_templates/segment_pets/segment_pets_distributed_w2.json
submit_job experiment_templates/segment_pets/segment_pets_distributed_w4.json
